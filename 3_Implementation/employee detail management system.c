...
int main()
{
    ...
    */
    ...
    while(1)
    {
        ...
        printf("1. Add details"); /// option for add record
        gotoxy(30,12);
        printf("2. List details"); /// option for showing existing record
        gotoxy(30,14);
        printf("3. Modify details"); /// option for editing record
        gotoxy(30,16);
        printf("4. Delete details"); /// option for deleting record
        gotoxy(30,18);
